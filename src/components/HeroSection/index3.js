          ...
          <Wrap>
            <HeaderWrapper>
              <div className="header3">
                ...
                <span className="animated-text3">
                  <div className="line3">Easy</div>
                  <div className="line3">Enjoyable</div>
                  <div className="line3">Reassuring</div>
                  <div className="line3">Successful</div>
                </span>
              </div>
            </HeaderWrapper>
            <PWrap>
              ...
              <BtnWrap>
                <Button to="/latest-stock" primary="true" dark="true">
                  Latest stock
                </Button>
              </BtnWrap>
            </PWrap>
